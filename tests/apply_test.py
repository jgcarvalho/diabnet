...
class TestPredictor(unittest.TestCase):
    def setUp(self):
        self.feat_names = ["snp_1126","snp_2444","snp_1","snp_1757","snp_9","snp_11","snp_2454","snp_10","snp_376","snp_8",
        ...
        self.predictor = apply.Predictor('models/model-layer01-FEAT-SELECT-50BW-001.pth', self.feat_names, 'data/negatives_older60.csv')
